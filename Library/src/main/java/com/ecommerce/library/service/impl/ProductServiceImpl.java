...
public class ProductServiceImpl implements ProductService {
    ...
    public Page<ProductDto> getAllProducts(int pageNo) {
        Pageable pageable = PageRequest.of(pageNo, 3); // Page thứ "pageNo" và có số element là 3
...
//    Ta có thể tạo một đối tượng PageRequest bằng cách truyền vào số trang yêu cầu và kích thước trang. PageRequest.of(0, 2);
//        Ta có thể hiểu Page<ProductDto> tương tự như List<ProductDto>
//    ở đây Page<ProductDto> chứa danh sách các sản phẩm của page mà ta chọn

    private Page toPage(List list, Pageable pageable) {
        if (pageable.getOffset() >= list.size()) {
//            pageable.getOffset() trong Spring Data JPA là phương thức dùng để lấy vị trí bắt đầu
//            của bản ghi trong kết quả truy vấn dựa trên Paging và Sorting.
//            Ví dụ, nếu bạn muốn truy vấn các bản ghi từ trang thứ 2 với kích thước trang là 10,
//            phương thức getOffset() sẽ trả về giá trị là 10 (vị trí bắt đầu từ 0)
            return Page.empty();
        }
...
//        PageImpl trong Spring Boot là một lớp cài đặt của giao diện Page trong Spring Data.
//        Nó được sử dụng để đóng gói các kết quả của truy vấn phân trang.
//
//Khi sử dụng PageImpl, bạn có thể trả về các trang kết quả từ truy vấn phân trang và
// cung cấp thông tin về tổng số phần tử, số trang, kích thước trang và các thuộc tính khác liên quan đến phân trang.
    }
