...
public class ProductController {
    ...
    public String enabledProduct(@RequestParam(value = "id")Long id, RedirectAttributes redirectAttributes) {
        try {
    ...
    public String deletedProduct(@RequestParam(value = "id")Long id, RedirectAttributes redirectAttributes) {
        try {
