...
//    addFlashAttribute được sử dụng để truyền thông tin giữa các request liên tiếp,
//    thông qua một cookie hoặc session lưu trữ tạm thời. Thông tin được truyền qua addFlashAttribute
//    chỉ được giữ lại trong vòng một request sau đó
//    Khi sử dụng RedirectAttributes thì phải trả về "return "redirect:/... ";"


    @RequestMapping(value = "/findById", method = {RequestMethod.PUT, RequestMethod.GET})
    @ResponseBody
    public Optional<Category> findById(@RequestParam(name = "id")Long id) {
        return categoryService.findById(id);
    }
//    Annotation @ResponseBody trong Spring Boot được sử dụng để chỉ định rằng phương thức trả về dữ liệu thô
//    thay vì một trang HTML. Điều này thường được sử dụng để tạo API REST.
